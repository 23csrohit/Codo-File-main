  ...
  return (
    ...
    <div className="container">
        ...
        <CodingPage
          ...
          path="https://drive.google.com/file/d/1di-VRK5JX3GoqsXz3G4RkefNdxSYFrJW/view?usp=drive_link"
          ...
          info={<>Achieved <mark><u>First</u></mark> position in <mark>Website Competition</mark> held in <mark>AIMT LUCKNOW(U.P).</mark> </>}
